export default function Footer() {
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/aklilu-abera',
      icon: (
    ...
    {
      name: 'YouTube',
      url: 'https://youtube.com/c/AkliluAbera',
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Upwork',
      url: 'https://upwork.com/freelancers/~01abcdefghijk',
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:akililuabera44@gmail.com',
      icon: (
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="border-t border-gray-200 mt-6 pt-6 text-center">
          <p className="text-foreground/60 text-sm">
            © {new Date().getFullYear()} Aklilu Abera. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
